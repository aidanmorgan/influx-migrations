...
public class TextWriterMigrationHistoryLogger : IMigrationHistoryLogger
{
    ...
    {
        _stream.WriteLine($"Exception thrown {x?.GetType().FullName} loading Migration History.".Pastel(ConsoleColor.Red));
    ...
    {
        _stream.WriteLine($"Exception thrown {x?.GetType().FullName} saving Migration History.".Pastel(ConsoleColor.Red));
        _stream.WriteLine($"{x.Message}.".Pastel(ConsoleColor.Red));
        _stream.WriteLine($"{x.StackTrace}.".Pastel(ConsoleColor.Red));
    }
}